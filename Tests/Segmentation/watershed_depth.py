...
"""
This script tests the possibility of using the z-value of the objects as an intensity image to get the object masks.

Conclusion: not ideal, especially if objects are close to each other at the same height
"""
